...
using Lab4_DataFirst.Models;

namespace Lab4_DataFirst.Controllers
{
    public class LearnersController : Controller
    {
        private readonly Lab4CodeFirstContext _context;
        ...
        {
            var lab4CodeFirstContext = _context.Learners.Include(l => l.Major);
            return View(await lab4CodeFirstContext.ToListAsync());
        }
