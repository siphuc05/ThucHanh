...
namespace Lab3.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Password,Branch,Gender,IsRegular,Address,DateOfBirth")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Password,Branch,Gender,IsRegular,Address,DateOfBirth")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
